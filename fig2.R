...
sig_genes_log10_heatmap <- ggplot(data = sig_genes) +
  ...
  scale_x_discrete(position = 'top',
                   labels = c('hom vs sibs', 'hom vs sibs post filter',
...
composite_fig <- plot_grid(embryo_stage_size_colour_plot, embryo_ko_expr_plot,
          mouse_baseline_ts_heatmap, sig_genes_log10_heatmap,
          ncol = 4, rel_widths = c(4,1,2,2), align = 'h' )

save_plot(file.path(plots_dir, "Figure2.eps"), composite_fig, ncol = 4, device = 'eps',
